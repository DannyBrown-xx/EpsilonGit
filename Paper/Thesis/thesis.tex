...
In order to allow a \code{GitModel} object to be created from the user interface provided by Epsilon Eclipse for cached models a class which implemented the abstract base class \code{AbstractCachedModelConfigurationDialog} is included in the design. This 
