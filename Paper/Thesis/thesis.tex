...
\begin{titlepage}
	...
	\begin{center}
		...
		\vspace{5cm}
		\small 4,260 words as counted by Texpad.app
	\end{center}
	\restoregeometry
\end{titlepage}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.55\textwidth]{images/imodel-interface}
...
Project managers, team leads or individuals who want to use the software solution to analyse their git repositories using in-built queries or by developing their own. The main "users" of the system.
