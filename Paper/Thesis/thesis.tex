...
\subsubsection{Methods}
\begin{enumerate}
	\item Implement the \code{IModel} interface to integrate with the Model Connectivity Layer of Epsilon
...
This would primarily be useful to enable easy extensibility to the software in the future
